...
# =====================================================================
#               Grid Search combiné PARALLÉLISÉ
# =====================================================================
from scipy.sparse import hstack

def _fit_vectorizer(texts_fit, params):
    """Helper pour créer et fitter un CountVectorizer"""
    vec = CountVectorizer(
...
def grid_search_bow_combined_parallel(
    texts_name,
    texts_desc,
    true_labels,
    n_clusters=7,
    ...
    """
    Grid search parallèle : teste toutes les combinaisons (name × desc) sur plusieurs CPU.
    """
    # grilles par défaut
...
# =====================================================================
print("\nLancement du grid search parallèle (features combinées)...")

name_grid = {
    "max_features": [11, 13, 15, 16, 17 ],
    "ngram_range": [(1,1), (1,2), (1,3)],
    "min_df": [1, 2, 3],
    "max_df": [0.70, 0.85, 0.90],
}

desc_grid = {
    "max_features": [175,180,185],
    "ngram_range": [(1,3), (1,4), (1,5)],
    "min_df": [0.01, 0.02, 0.05],
    "max_df": [0.70, 0.80, 0.90],
}

results_parallel, best_combined = grid_search_bow_combined_parallel(
